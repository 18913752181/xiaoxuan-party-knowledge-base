...
function node(sourceOrder, stageId, title, timeRequirement, responsibleParties, sourceMaterials, timing, extra) {
  return Object.assign({
    ...
    title,
    action: title,
    timeRequirement: timeRequirement || "Excel未明确时间要求",
    prerequisite: sourceOrder === 1 ? "无前置流程节点" : "完成前序流程，并满足本节点时间要求",
    responsibleParties: responsibleParties || [],
    sourceMaterials: sourceMaterials || [],
    requiredMaterials: [],
    generatedMaterials: [],
    materialClassification: sourceMaterials && sourceMaterials.length ? "Excel仅列出“对应材料”，未区分所需材料与形成材料" : "Excel未列明材料",
...
const nodes = [
  ...
  node(4, "activist", "工会推优（35周岁以下，一般群团推优二选一）", "可在同一天", ["工会"], ["工会推优记录"], { type: "sameDay", anchorId: "step-03" }, { notes: ["Excel注明：35周岁以下，一般群团推优二选一。"] }),
  node(5, "activist", "共青团推优（28岁以下青年团员需要）", "可在同一天", ["团委"], ["共青团推优记录"], { type: "sameDay", anchorId: "step-03" }, { notes: ["Excel注明：28岁以下青年团员需要。"] }),
  ...
  node(12, "activist", "撰写个人自传（需手写，见模板）", "成为积极分子一个月内", ["本人"], ["个人自传"], { type: "deadlineMonths", anchorId: "step-07", months: 1, label: "一个月内完成的截止参考日" }, { notes: ["Excel注明：需手写，见模板。"] }),
  ...
  node(15, "development-target", "初步筛选确定发展人选", "成为积极分子满一年", ["党支部"], ["初步筛选"], { type: "offsetYears", anchorId: "step-07", years: 1, label: "满一年最早参考日" }, { notes: ["“积极分子考察满1年才能成为发展对象”为用户已确认规则；Excel将“初步筛选”列在对应材料栏，是否属于材料待确认。"] }),
  node(16, "development-target", "确定为拟发展对象前向党小组征求意见（如有）", "可在同一天", ["党小组"], ["党小组会议记录"], { type: "sameDay", anchorId: "step-15" }, { notes: ["Excel将第16、17项合并描述；此处按两个原始序号拆分展示。"] }),
  node(17, "development-target", "召开党员群众座谈会征求意见（党员群众总人数不少于10人）", "可在同一天", ["党支部"], ["党员群众座谈会记录"], { type: "sameDay", anchorId: "step-15" }, { notes: ["Excel将第16、17项合并描述；党员群众总人数不少于10人。"] }),
  ...
  node(21, "development-target", "发展对象公示（五个工作日）", "支部讨论、党委通过后", ["党支部"], ["发展对象公示"], { type: "after", anchorId: "step-20", durationWorkingDays: 5 }, { notes: ["Excel明确公示五个工作日；法定节假日安排需人工核对。"] }),
  ...
  node(37, "probation-reception", "录入党务系统", "党委审议通过后", ["基层党委"], [], { type: "after", anchorId: "step-36" }, { materialClassification: "Excel对应材料栏为“/”，含义待确认" }),

  node(38, "probation-education", "编入党支部和党小组，参加组织生活，缴纳党费", "接收当月起", ["党支部"], [], { type: "sameMonth", anchorId: "step-33" }, { materialClassification: "Excel对应材料栏为“/”，含义待确认" }),
  node(39, "probation-education", "入党宣誓", "建议成为预备党员一个月内", ["党委/党支部"], ["宣誓照片"], { type: "advisoryDeadlineMonths", anchorId: "step-33", months: 1, label: "建议一个月内办理的参考日" }, { notes: ["Excel使用“建议”表述，本系统不将其判定为强制期限。"] }),
  node(40, "probation-education", "思想汇报（每季度一篇，需手写，与《预备党员考察表》中的季度小结有所区别）", "续写", ["本人"], ["每季度思想汇报"], { type: "manual" }, { notes: ["Excel写明每季度一篇，但“续写”未明确首次日期锚点，因此不生成具体日期。"] }),
  ...
  node(42, "conversion", "转正申请（手写，见模板）", "预备期满前两周", ["本人"], ["转正申请"], { type: "beforeAnniversary", anchorId: "step-33", years: 1, daysBefore: 14, label: "预备期满前两周参考日" }, { notes: ["Excel注明：手写，见模板。"] }),
  node(43, "conversion", "党小组讨论（如有）", "预备期满后，可在同一天", ["党小组"], ["党小组会议记录"], { type: "anniversary", anchorId: "step-33", years: 1, label: "预备期满参考日" }),
  node(44, "conversion", "听取党员群众意见（党员群众总人数不少于10人）", "预备期满后，可在同一天", ["党支部"], ["党员群众座谈会记录"], { type: "sameDay", anchorId: "step-43" }, { notes: ["Excel注明：党员群众总人数不少于10人。"] }),
  node(45, "conversion", "拟转正公示（五个工作日）", "预备期满后，可在同一天", ["党支部"], ["拟转正公示"], { type: "sameDay", anchorId: "step-43", durationWorkingDays: 5 }, { notes: ["Excel明确公示五个工作日；法定节假日安排需人工核对。"] }),
  ...
  node(50, "conversion", "支部向大会公布结果", "Excel未明确时间要求", ["党支部"], ["党员大会会议记录"], { type: "after", anchorId: "step-49" }),

  node(51, "archive", "材料归档", "Excel未明确时间要求", ["党支部"], ["归档记录"], { type: "after", anchorId: "step-50" })
];
...
module.exports = {
  version: "excel-2026-08-17-v1",
  reviewedAt: "2026-08-17",
  sourceTitle: "《党员发展材料目录.xlsx》",
