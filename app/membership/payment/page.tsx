    ...
    <main className="dimmo-membership-page">
      <div className="dimmo-membership-shell">
        ...
        <section className="dimmo-membership-content">
          <div className="dimmo-membership-intro"><p>喵喵工作台</p><span>完整资料、任务小本本、小程序教育基地攻略和 Dimmo 的日常陪伴。</span></div>
            ...
            <div>
              ...
              <div className="dimmo-membership-note">
                <p>通行卡会员权益</p><ul>
                  ...
                  <li><span className="dimmo-benefit-symbol" aria-hidden="true">⌖</span><span><b>小程序教育基地攻略</b><small>按地区和类型查基地，收藏点位、整理路线，查看参观联系、讲解信息和配套方案</small></span></li>
