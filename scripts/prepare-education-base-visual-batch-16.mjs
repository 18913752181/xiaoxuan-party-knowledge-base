...
const sqlPath = path.join(root, "supabase", "036_education_base_visuals_batch_16.sql");
const batchIds = [71, 74, 107, 133, 136];
...
const sql = `-- education-base-visuals 第 16 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
