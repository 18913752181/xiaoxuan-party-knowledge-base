...
const sqlPath = path.join(root, "supabase", "041_education_base_visuals_batch_21.sql");
const batchIds = [121, 122];
...
const sql = `-- education-base-visuals 第 21 批：2 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
