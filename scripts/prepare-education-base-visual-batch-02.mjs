...
const sqlPath = path.join(root, "supabase", "022_education_base_visuals_batch_02.sql");
const batchIds = [42, 66, 102, 110, 145];
...
const sql = `-- education-base-visuals 第 2 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
