...
const sqlPath = path.join(root, "supabase", "031_education_base_visuals_batch_11.sql");
const batchIds = [116, 119, 135, 138, 141];
...
const sql = `-- education-base-visuals 第 11 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
