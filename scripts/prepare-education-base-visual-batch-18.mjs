...
const sqlPath = path.join(root, "supabase", "038_education_base_visuals_batch_18.sql");
const batchIds = [13, 41, 46, 100, 139];
...
const sql = `-- education-base-visuals 第 18 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
