...
const sqlPath = path.join(root, "supabase", "033_education_base_visuals_batch_13.sql");
const batchIds = [38, 43, 105, 117, 144];
...
const sql = `-- education-base-visuals 第 13 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
