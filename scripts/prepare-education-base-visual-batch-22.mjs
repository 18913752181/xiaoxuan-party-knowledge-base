...
const sqlPath = path.join(root, "supabase", "042_education_base_visuals_batch_22.sql");
const batchIds = [16, 28, 52, 73, 97, 118, 126];
...
const sql = `-- education-base-visuals 第 22 批：7 个用户提供照片并通过四项验收的基地插图。\n` +
  `begin;\n\n` +
