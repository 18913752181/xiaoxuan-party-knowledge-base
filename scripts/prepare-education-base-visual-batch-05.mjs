...
const sqlPath = path.join(root, "supabase", "025_education_base_visuals_batch_05.sql");
const batchIds = [40, 92, 106, 109, 143];
...
const sql = `-- education-base-visuals 第 5 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
