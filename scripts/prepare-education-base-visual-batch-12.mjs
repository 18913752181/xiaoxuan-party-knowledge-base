...
const sqlPath = path.join(root, "supabase", "032_education_base_visuals_batch_12.sql");
const batchIds = [4, 11, 104, 131, 134];
...
const sql = `-- education-base-visuals 第 12 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
