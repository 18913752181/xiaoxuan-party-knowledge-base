...
const sqlPath = path.join(root, "supabase", "023_education_base_visuals_batch_03.sql");
const batchIds = [150, 151, 152, 153, 154];
...
const sql = `-- education-base-visuals 第 3 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
