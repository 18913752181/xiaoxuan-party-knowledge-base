...
const sqlPath = path.join(root, "supabase", "035_education_base_visuals_batch_15.sql");
const batchIds = [37, 39, 45, 47, 81];
...
const sql = `-- education-base-visuals 第 15 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
