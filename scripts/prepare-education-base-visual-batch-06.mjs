...
const sqlPath = path.join(root, "supabase", "026_education_base_visuals_batch_06.sql");
const batchIds = [86, 93, 125, 142, 146];
...
const sql = `-- education-base-visuals 第 6 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
