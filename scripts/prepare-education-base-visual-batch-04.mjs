...
const sqlPath = path.join(root, "supabase", "024_education_base_visuals_batch_04.sql");
const batchIds = [64, 68, 70, 103, 108];
...
const sql = `-- education-base-visuals 第 4 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
