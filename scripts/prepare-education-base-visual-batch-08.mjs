...
const sqlPath = path.join(root, "supabase", "028_education_base_visuals_batch_08.sql");
const batchIds = [8, 77, 101, 123, 124];
...
const sql = `-- education-base-visuals 第 8 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
