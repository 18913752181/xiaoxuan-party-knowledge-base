...
const sqlPath = path.join(root, "supabase", "037_education_base_visuals_batch_17.sql");
const batchIds = [51, 89, 98, 99, 127];
...
const sql = `-- education-base-visuals 第 17 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
