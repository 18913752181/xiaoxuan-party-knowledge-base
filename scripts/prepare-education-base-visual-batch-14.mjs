...
const sqlPath = path.join(root, "supabase", "034_education_base_visuals_batch_14.sql");
const batchIds = [26, 48, 49, 50, 137];
...
const sql = `-- education-base-visuals 第 14 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
