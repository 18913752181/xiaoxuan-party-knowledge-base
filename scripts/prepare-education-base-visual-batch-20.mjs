...
const sqlPath = path.join(root, "supabase", "040_education_base_visuals_batch_20.sql");
const batchIds = [3, 6, 9, 76];
...
const sql = `-- education-base-visuals 第 20 批：4 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
