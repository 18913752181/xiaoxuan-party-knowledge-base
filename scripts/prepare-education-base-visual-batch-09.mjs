...
const sqlPath = path.join(root, "supabase", "029_education_base_visuals_batch_09.sql");
const batchIds = [79, 80, 82, 132, 149];
...
const sql = `-- education-base-visuals 第 9 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
