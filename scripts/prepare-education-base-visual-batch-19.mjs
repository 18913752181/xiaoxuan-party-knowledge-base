...
const sqlPath = path.join(root, "supabase", "039_education_base_visuals_batch_19.sql");
const batchIds = [17, 20, 21];
...
const sql = `-- education-base-visuals 第 19 批：3 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
