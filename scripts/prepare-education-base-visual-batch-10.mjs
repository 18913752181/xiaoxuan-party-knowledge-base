...
const sqlPath = path.join(root, "supabase", "030_education_base_visuals_batch_10.sql");
const batchIds = [120, 128, 129, 130, 140];
...
const sql = `-- education-base-visuals 第 10 批：5 个已通过四项验收的基地插图。\n` +
  `begin;\n\n` +
